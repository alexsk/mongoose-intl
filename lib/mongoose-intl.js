...
module.exports = exports = function (schema, options) {
    ...
    schema.eachPath(function (path, schemaType) {
        ...
        schema.virtual(path)
            .get(function (param) {
                return param[pluginOptions.defaultLanguage];
            })
            .set(function (value) {
                this.set(path + '.' + pluginOptions.defaultLanguage, value);
            });
    ...
    schema.method({
        getLanguages: function () {
            return pluginOptions.languages;
        },
        getDefaultLanguage: function () {
            return pluginOptions.defaultLanguage;
        },
        setDefaultLanguage: function (lang) {
            if (lang && pluginOptions.languages.indexOf(lang) !== -1) {
                pluginOptions.defaultLanguage = lang.slice(0);
            }
        }
    });
};
